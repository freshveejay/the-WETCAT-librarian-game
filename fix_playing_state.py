...
content = re.sub(
    r"this\.particles = this\.particles\.filter",
    "// Particles handled by ParticleSystem",
    content,
)
content = re.sub(
    r"for \(const particle of this\.particles\)",
    "// Particle rendering handled by ParticleSystem",
    content,
)
...
content = re.sub(
    r"(this\.particleSystem = new ParticleSystem.*?;)", r"\1" + init_code, content
)
